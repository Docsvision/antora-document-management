...
Текст стандартного XSLT-преобразования, используемого для формирования почтовых уведомлений автору задания, размещен на ресурсе GitHub в папке https://github.com/DocsVision/DeveloperItems/tree/master/xslt-templates/email-templates, файл `AdditionalEmailNotifications.xsl`.
