...
Текст стандартного XSLT-преобразования, используемого для формирования почтовых уведомлений автору задания, размещен на ресурсе GitHub в папке https://github.com/DocsVision/DeveloperItems/tree/master/xslt-templates/email-templates, файл [.ph .filepath]`AdditionalEmailNotifications.xsl`.
...
<MailInfo>
  ...
  <SendInfo Date="понедельник, 15 апреля" CardUrl="http://docsvision.company.com/Docsvision/?CardID={9421e319-cdb2-4a7c-a3bd-68dd301c3dc5}&amp;ShowPanels=2048" />
  <Data>
